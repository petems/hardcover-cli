...
// GetDescription returns SearchBooksSearchBookSearchResultsResultsBook.Description, and is useful for accessing the field via an interface.
func (v *SearchBooksSearchBookSearchResultsResultsBook) GetDescription() string { return v.Description }
...
// GetSearchType returns __SearchBooksInput.SearchType, and is useful for accessing the field via an interface.
func (v *__SearchBooksInput) GetSearchType() SearchType { return v.SearchType }
...
query SearchBooks ($query: String!, $searchType: SearchType = BOOKS) {
